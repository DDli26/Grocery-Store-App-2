//for registering a new user, or a store manager
export default{
    template: `
<div class="d-flex justify-content-center" style="margin-top: 30vh">
  ...
  <br> <br>
  <button class="btn btn-primary"  @click='register_manager'>Register as a Manager</button>
    </div>
</div> 
`, 
  data(){
  ...
  methods:{
    ...
    async register_manager(){  
        // console.log(this.cred) //check console and see
        const res=await fetch("/manager-register", 
        {
            method: "POST",
            headers: {
                "Content-Type":"application/json"
